...
export class BooksApiEffects {
  ...
  createBook$= createEffect(()=>
    this.actions$.pipe(
      ...
      .pipe(map((book)=> BooksApiActions.booksCreated({book})))
    ))
  )
  ...
  cupdateBook$= createEffect(()=>
    this.actions$.pipe(
      ...
      concatMap((action)=>
      this.booksService.update(action.bookId, action.changes)
  ...
  deleteBook$= createEffect(()=>
    this.actions$.pipe(
      ...
      mergeMap((action)=>
      this.booksService.delete(action.bookId)
