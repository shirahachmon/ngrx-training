// import { booksLoaded } from './../../../books-page/actions/src/lib/books-api.actions';
import { createReducer, on, Action, createSelector, INITIAL_REDUCERS, createAction } from '@ngrx/store';
...
const deleteBook = (books: BookModel[], bookId: string) =>
  ...
  export const reducer= createReducer(
    ...
    on(BooksApiActions.booksCreated, (state, action) => {
      return{
